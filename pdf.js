...
const { uploadPdf, downloadLogoBuffer } = require('./storage');
...
async function generateQuotePdf(job, customer, business, seqNum) {
...
async function generateInvoicePdf(job, invoice, customer, business, seqNum) {
